    ...
    scrollEl.addEventListener('scroll', function () {
        if (!_this.timer) {
            _this.timer = setTimeout(function () {
                ...
                try {
                    for (var _iterator = _this.handleList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
Scroll.prototype.removeElModifyHandle = function (id) {
    var temp = this.handleList[id].act;
        ...
        var ScrollOver = function (_React$Component) {
            ...
            _createClass(ScrollOver, [{
                ...
                value: function elModifyHandle() {
                    var el = scroll.scrollEl;
                    el.removeEndEventListener('scroll', this.checkEmit);
                    el.addEventListener('scroll', this.checkEmit);
                }
            }, {
                key: 'registerHandle',
